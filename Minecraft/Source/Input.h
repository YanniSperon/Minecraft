...
#include "glfw3.h"
#include <vector>
#define KEYBOARD_KEYS_SIZE 512
#define MOUSE_BUTTONS_SIZE 64
...
#define MC_KEY_WORLD_1            161
#define MC_KEY_WORLD_2            162
...
#define MC_MOD_SHIFT           0x0001
#define MC_MOD_CONTROL         0x0002
#define MC_MOD_ALT             0x0004
#define MC_MOD_SUPER           0x0008
#define MC_MOD_CAPS_LOCK       0x0010
#define MC_MOD_NUM_LOCK        0x0020

#define MC_KEY_RELEASE            0
#define MC_KEY_PRESS              1
#define MC_KEY_REPEAT             2
...
namespace MC {
	...
	struct KeyboardInput {
		...
		std::vector<bool> m_KeysHeld;
		std::vector<bool> m_KeysReleased;
		bool m_ShouldReceiveInput;

		KeyboardInput() {
			m_KeysPressed = std::vector<bool>(KEYBOARD_KEYS_SIZE, false);
			m_KeysHeld = std::vector<bool>(KEYBOARD_KEYS_SIZE, false);
			m_KeysReleased = std::vector<bool>(KEYBOARD_KEYS_SIZE, false);
