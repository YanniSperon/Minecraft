...
Config::Config()
	: m_StartingWidth(1280), m_StartingHeight(720), m_HasVSync(0), m_HasRawMouseInput(0), m_FOV(70.0f), m_MouseSensitivity(0.2f), m_HasSmoothLighting(1), m_RenderDistance(16), m_ParticleQuality(2), m_ShadowQuality(2)
{
	Load();
}
